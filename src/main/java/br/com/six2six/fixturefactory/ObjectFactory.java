...
public class ObjectFactory {
	...
	protected Object createObject(Rule rule) {
		...
		if(GeneratedMessage.class.isAssignableFrom(clazz)) {
			return createProtobufObject(rule, clazz);
		} else {
			return createPojoObject(rule, constructorArguments, clazz);
		}
	}
	...
	private Object createPojoObject(Rule rule, Map<String, Property> constructorArguments, Class<?> clazz) {
